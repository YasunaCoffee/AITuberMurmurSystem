...
from murmur.core.events import StreamSummaryReady, PrepareStreamSummary
from config import config
from murmur.runtime.character_runtime import get_ai_speaker_labels
...
class StreamSummaryHandler:
    ...
    def _generate_summary_from_logs(self, log_file: str, summary_file: str) -> bool:
        ...
        try:
            ...
            _cn = get_character().name
            summary_content = f"""# 🌙 {_cn}配信サマリー

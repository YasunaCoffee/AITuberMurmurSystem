...
from murmur.core.events import PrepareMonologue, MonologueReady
from murmur.handlers.monologue_handler import MonologueHandler

class TestMonologueHandler(unittest.TestCase):

    @patch('murmur.handlers.monologue_handler.PromptManager')
    @patch('murmur.handlers.monologue_handler.MasterPromptManager')
    @patch('murmur.handlers.monologue_handler.ModeManager')

...
class TestCommentHandler(unittest.TestCase):
    ...
    @patch('murmur.handlers.comment_handler.PromptManager')
    @patch('murmur.handlers.comment_handler.MasterPromptManager')
    @patch('murmur.handlers.comment_handler.ModeManager')
    @patch('murmur.handlers.comment_handler.CommentFilter')
    @patch('murmur.handlers.comment_handler.ConversationHistory')
    @patch('murmur.handlers.comment_handler.MemoryManager')

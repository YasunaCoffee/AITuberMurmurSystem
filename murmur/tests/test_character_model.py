...
class TestCharacterIdentity:
    ...
    def test_identity_has_required_fields(self):
        from murmur.models.character import CharacterIdentity
...
class TestCharacterPrompts:
    ...
    def test_prompts_has_persona_path(self):
        from murmur.models.character import CharacterPrompts
...
class TestCharacterMemory:
    ...
    def test_memory_config(self):
        from murmur.models.character import CharacterMemory
...
class TestCharacter:
    ...
    def _make_character(self):
        from murmur.models.character import (
            Character,
            CharacterIdentity,
            VoiceConfig,
            CharacterPrompts,
...
"""
    ...
    def test_load_character_from_yaml(self):
        from murmur.models.character import Character, load_character
